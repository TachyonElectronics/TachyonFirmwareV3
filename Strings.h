...
const PROGMEM char Str_AB_Bullets[] = "Bullet";
const PROGMEM char* const ABLabels[] = {Str_AB_Solid,Str_AB_Bullets};
...
const PROGMEM char Str_CM_Visual[] = "Visual";
const PROGMEM char* const CMSettings[] = {Str_Off, Str_CM_Visual};
